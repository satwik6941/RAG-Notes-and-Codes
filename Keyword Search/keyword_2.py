...
The text is extracted from the pdf and then the text is preprocessed such that symbols are removed and everything is converted to lowercase. Then we create the embeddings using TFIDVectorizer, which converts the documents and query into vectors.
